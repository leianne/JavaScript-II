...
let largeShirts = runners.filter(function(e){
...
let ticketPriceTotal = runners.reduce(function(t, e){
    return t += e.donation
}, 0);
...
// Problem 1
//There was an issue with our email server an none of the emails ending in .com where sent out... Get us that list!
let comEmails = runners.filter(function(e){
    return e.email.includes('.com')
})
